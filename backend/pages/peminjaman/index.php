...
<style>
/* Custom CSS untuk Halaman Peminjaman */
...
/* Tombol Tambah Peminjaman dengan Gradient */
.btn-primary {
...
.btn-success:hover {
    ...
    box-shadow: 0 5px 15px rgba(132, 250, 176, 0.5);
    color: white;
}
...
<main class="container">
    <div class="content" style="padding-left: 230px; padding-top: 100px">
        ...
        <div class="page-header">
            ...
            <p>Kelola data peminjaman barang</p>
        </div>

        <a href="tambah.php" class="btn btn-primary mb-3">
            <i class="feather icon-plus-circle"></i> Tambah Peminjaman
        </a>
                        ...
                        <?php if(mysqli_num_rows($data) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td data-label="Status">
                                    ...
                                    elseif($status == 'batal') $statusClass = 'batal';
                                ...
                                <td data-label="Aksi">
                                    <?php if($p['status'] == 'dipinjam'): ?>
                                        <a href="kembalikan.php?id=<?= $p['id_peminjaman'] ?>"
                                           ...
                                           data-tooltip="Kembalikan Barang">
                                            <i class="feather icon-rotate-ccw"></i> Kembalikan
                                        </a>
                                    <?php else: ?>
                                        <span class="badge-secondary" style="display: inline-block; margin-right: 5px;">
